...
data class MovieEntity(
    ...
    @ColumnInfo("countries") val countries: String, // Можно использовать конвертеры для списка
    @ColumnInfo("genres") val genres: String, // Можно использовать конвертеры для списка
